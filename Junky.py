...
class Junky():
    ...
    def generate_imports(self):
        imports = [ "System", "System.CodeDom", "System.Collections", "System.ComponentModel", "System.Configuration", "System.Deployment", "System.Diagnostics", "System.Diagnostics.CodeAnalysis", "System.Diagnostics.Contracts", "System.Diagnostics.Eventing", "System.Diagnostics.Tracing", "System.Diagnostics.PerformanceData", "System.Dynamic", "System.Globalization", "System.IO", "System.Linq", "System.Management", "System.Media", "System.Net", "System.Reflection", "System.Timers","System.Timers","System.Threading","System.Text","System.Text.RegularExpressions", "System.Security", "System.Runtime", "System.Resources", "System.Windows" ]
        junk = "/* START JUNK */\n"
    ...
    def generate_if(self):
        ...
        condition = ""
        for i in range(random.randint(1, 3)):
            condition += " ((ulong){} {} {}) ".format(self.generate_ulong(), random.choice(operand_types), self.generate_ulong())
    ...
    def generate_enum(self):
        values = [ "int", "uint", "long", "ulong", "byte", "short" ]
        junk = "[Flags]\n"
        value = random.choice(values)
    ...
    def generate_global_var(self):
        var_types = [ "string", "string[]", "int", "int[]", "long", "long[]", "ulong", "ulong[]", "UIntPtr", "UIntPtr[]", "IntPtr", "IntPtr[]", "bool", "bool[]", "sbyte", "sbyte[]", "short", "short[]", "byte", "byte[]", "ushort", "ushort[]", "uint", "uint[]", "char", "char[]", "float", "float[]", "double", "double[]", "decimal", "decimal[]", "object",  "object[]" ]
